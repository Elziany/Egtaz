...
@section('content')
    ...
    <div class="container-xl px-4 mt-4">
        ...
        <nav class="nav nav-borders">
            <a class="nav-link " href="{{route('profile')}}">{{__('room.profile')}}</a>
            <a class="nav-link active" href="{{route('password',$lecturer->id)}}">{{__('room.security')}}</a>
...
@endif
                    <div class="card-body">
                        <form action="{{route('changePassword',$lecturer->id)}}" method="POST">
                            @csrf
                            ...
                            <div class="mb-3">
                                <label class="small mb-1" for="confirmPassword">{{__('room.confirm')}}</label>
